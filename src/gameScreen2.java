 ...
 */
public class gameScreen2 extends javax.swing.JFrame {

    int gridXVal = 16; //Grid size
    int gridYVal = 16;
    ...
    int difficulty = 7; //difficulty of gmae, used as a modifier for number of mines
    ...
    gameScreen2(MineSweeper in) { //as a go-between for intro screen and gameScreen
    ...
    public void win() { //run if game is won
        ...
        { //win dialog
            JOptionPane.showMessageDialog(null, ""
                    + "Wow! Good job, you Win!!!!!\nPress \"Reset\" to play again! You beat intermediate - good job.", "Victory!", JOptionPane.QUESTION_MESSAGE);
        }
    }
